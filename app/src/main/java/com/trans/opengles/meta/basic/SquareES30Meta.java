...
/**
 * @author Tom灿
 * @description: 绘制一个矩形GLES3.0
 * @date :2023/11/6 15:56
 */
public class SquareES30Meta implements Render {
    private static final Render INSTANS = new SquareES30Meta();
...
//        GLES30.glDrawArrays(GLES30.GL_TRIANGLES, 0, POSITION_COMPONENT_COUNT);
    ...
    /**
     * 绘制矩形: 应用了变换矩阵（添加了相机视图和透视投影）
     */
    private void drawSquare30() {
