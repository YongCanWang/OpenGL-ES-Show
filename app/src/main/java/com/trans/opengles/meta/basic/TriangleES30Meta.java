...
/**
 * @author Tom灿
 * @description: 绘制一个三角形GLES3.0
 * @date :2023/11/6 15:56
 */
public class TriangleES30Meta implements Render {
    private static final Render INSTANS = new TriangleES30Meta();
